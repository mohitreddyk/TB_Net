# -*- coding: utf-8 -*-
"""
Created on Sun Sep 16 17:58:31 2018
...
#        print (type(labels))
        ...
        # print statistics
        if i == (trainsize/2)-1:#394:    # print every 37 batch
            print('[epoch: %d,batch number: %5d] loss: %.3f' %(epoch + 1, i + 1, running_loss / 2))
...
#saving model
torch.save(net,'checkpoint/modelfinetunewithdifferentresnet.pth')
